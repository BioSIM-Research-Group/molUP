...
proc gaussianVMD::loadMolecule {fileName timeWhenWasSaved option} {
	 ##Load the Molecule
	  mol new $gaussianVMD::tmpFolder/[subst $timeWhenWasSaved]/[subst $fileName].pdb type pdb first 0 last -1 step 1 filebonds 1 autobonds 1 waitfor 1
	...
	if {$option == "allStructures"} {
		mol addfile $gaussianVMD::tmpFolder/[subst $timeWhenWasSaved]/[subst $fileName].xyz type xyz first 0 last -1 step 1 waitfor 1
	} else {
